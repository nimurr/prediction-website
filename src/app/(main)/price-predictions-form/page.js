...
const Page = () => {
    ...
    return (
        <div className="contiainer ">
            <h2 className="text-sm text-gray-600 my-10 font-semibold"><span className='text-blue-600'>Home</span> &gt;  Submit Price Prediction </h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4 p-5 bg-gray-50 rounded-2xl my-10">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="Enter your Your Bitcoin Address "
                ...
                <div>
                    ...
                    <input
                        type="text"
                        name="bitcoinAddress"
                        placeholder="Bitcointalk Username "
